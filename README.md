...
To get the UI overlay to show up providing you with more information throughout the session, you'll need to add the latest version of [D3D8to9](https://github.com/crosire/d3d8to9/releases) to your game directory.
